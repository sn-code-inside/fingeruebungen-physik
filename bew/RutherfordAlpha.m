...
ZT = 2; ZZ = 79;            % zT=Teilchen, zZ=Streuzentrum Ladungen
kappa  = eq^2*ZZ*ZT/4/pi/eps0;
mT  = 14*u;                 % Teilchenmasse in atomic units
mZ  = 197*u;                % Streuzentrumsmasse in atomic units
En_eV   = [2e3,1e3,5e3];    % Energie in eV 
...
figure('name','Rutherford-Streuung \alpha -Teilchen an Au' )
axis ([-L L -L L])
grid on
ttl = title('Rutherford-Streuung \alpha -Teilchen an Au' );
