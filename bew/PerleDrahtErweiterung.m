...
% -------------------------------------------------------------------------
% Perle Draht Erweiterung
% 
% Programm berechnet die Lösung der Bewegungsgleichung mit
% Reibung für die Perle auf Draht mit verschiedenen Potentialen 
% -------------------------------------------------------------------------
clc
clear all
close all 
...
lambda1 = - muS/2 + 0.5*sqrt(muS^2 + 4*omega0^2);
lambda2 = - muS/2 - 0.5*sqrt(muS^2 + 4*omega0^2);
