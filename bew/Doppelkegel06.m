...
% gültige Lagrange-Funktion (Näherung 2) und 
...
yyaxis left;
hold on
p1(1)=plot(t,y,'Color',Colors(3,:), 'LineWidth',2,'LineStyle', Style(1));
grid on
...
yyaxis right;
hold on
p2(1)=plot(t,z,'Color',Colors(2,:), 'LineWidth',2, 'LineStyle', Style(1));
grid on
...
p(2) = plot(yr,zr,'Color',Colors(4,:), 'LineWidth',3);
...
legend(p,'Näherung 2','Schiene','location','southoutside');
legend box off
set(h,'FontSize',12,'FontWeight','normal'); 
set(gca,'FontSize',16);


fileID = fopen('Data/DKApprox02.txt','w');
