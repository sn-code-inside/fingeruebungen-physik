...
%%
% Numerisch ohne Reibung, aber mit Beschleunigung
% Beschleunigung auf T = 120 s in 10 s

DT     = 15;                         % Beshcleunigungsperiode in s
T0     = 120;                        % Rotationsperiode in s
omega0 = 2*pi/T0;                   
omeg = 0;
omegdot = omega0/DT;
...
titlestr3= strcat("   \DeltaT  \rm{= }" ,num2str(DT,'%3.0f s'));
