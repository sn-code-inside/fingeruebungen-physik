...
% -------------------------------------------------------------------------
% Programm berechnet die Parameter der Ellipsenbahn bzw. Hyperbelbahn
% für das Lambert-Problem bei vorgegebenen Positionsvektoren 1 und 2 
% in AE bzw. m und der Richtung Bewegung  ('pro','retro'), sowie
% der Flugzeit (TOF) in s. 
% Als Zentralkörper ist entweder die Erde (Rechnung in km und s)
% oder die Sonne (Rechnung in AE und d) angenommen.
% -------------------------------------------------------------------------
%
% Berechnung Lambert-Problem
%
% Input:                                         Einheit
%   vecr1       - Positionsvektor 1                 km oder AE
%   vecr2       - Positionsvektor 2                 km oder AE
%   dm          - Richtung Bewegung                 'pro','retro'
%   TOF         - Flugzeit                          s oder d
%
% OutPut (u.a.)
%   a           - Große Halbachse                  km oder AE
%   p           - semi-latus rectum                km oder AE
%   exz         - Exzentrizität                  
%   ups0        - Periapsis                    
...
muE  = 398600.4415;    % G*ME in km^3/s^2 fü¼r Erde
